...
The drawing above shows some data involving three variables:
...
Only a qualitative sketch is needed.  It will be good enough to draw out the graph on a piece of paper, roughly approximating the patterns of S and K seen in the graph.  Then draw the model values right on your paper.
...
```{r fig-4-3-ex1,fig = TRUE,pdf = TRUE,include = TRUE,width=3,height=3,echo = FALSE}
basic.plot()
...
a. D ~ A + G
    ...
    ANSWER
    ```{r fig-4-3-q1,fig = TRUE,pdf = TRUE,include = TRUE,width=3,height=3,echo = FALSE}
basic.plot()
m = lm( D ~ A+G, data=df)
h = coef(m)
...
#. D ~ A * G
    ...
    ANSWER
    ```{r fig-4-3-q2,fig = TRUE,pdf = TRUE,include = TRUE,width=3,height=3,echo = FALSE}
basic.plot()
m = lm( D ~ A*G, data=df)
h = coef(m)
...
#.  D ~ A - 1
    ...
    ANSWER
    ```{r fig-4-3-q3,fig = TRUE,pdf = TRUE,include = TRUE,width=3,height=3,echo = FALSE}
basic.plot()
m = lm( D ~ A-1, data=df)
h = coef(m)
...
#. D ~ 1
    ...
    ANSWER
    ```{r fig-4-3-q4,fig = TRUE,pdf = TRUE,include = TRUE,width=3,height=3,echo = FALSE}
basic.plot()
m = lm( D ~ 1, data=df)
h = coef(m)
...
#. D ~ A
    ...
    ANSWER
    ```{r fig-4-3-q5,fig = TRUE,pdf = TRUE,include = TRUE,width=3,height=3,echo = FALSE}
basic.plot()
m = lm( D ~ A, data=df)
h = coef(m)
...
#. poly(A, 2)
    ...
    ANSWER
    ```{r fig-4-3-q6,fig = TRUE,pdf = TRUE,include = TRUE,width=3,height=3,echo = FALSE}
basic.plot()
